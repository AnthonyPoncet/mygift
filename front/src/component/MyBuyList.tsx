...
function openGift(
  ...
  token: string,
  setShowGift: any,
  setModalGiftTitle: any,
  setModalGiftBody: any,
  setModalGiftFooter: any,
  setBuyList: any,
  appDispatch: any,
  friendwishlist: any,
  mywishlist: any,
      ...
      {(reservedBy.length === 0 || reservedByMe) && (
        <>
          <Button
            ...
            onClick={() =>
              reserve(gift.id, reservedByMe, token, setBuyList, appDispatch)
            }
          >
...
function openDeletedGift(
  ...
  setModalGiftFooter(
    <Button
      color="primary"
      onClick={() =>
        deleteDeletedGift(gift.id, token, setBuyList, setShowGift, appDispatch)
      }
    >
      {myBuyList.ok}
    </Button>
                ...
                <div key={"friendAndGifts" + fgi}>
                  ...
                  <div className="mycard-row">
                    ...
                    {fg.deletedGifts.map((gift: any, gi: any) => {
                      return (
                        <div
                          className="mycard warning-border"
                          onMouseEnter={() =>
                            setGiftHover(fgi + "-" + gi + "-deleted")
                          }
                          onMouseLeave={() => setGiftHover("")}
                          style={{ cursor: "pointer" }}
                        >
