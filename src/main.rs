...
async fn main() {
    ...
    let app = Router::new()
        ...
        .nest_service("/mywishlist/add-gift", serve_dir.clone())
        .nest_service("/mywishlist/add-category", serve_dir.clone())
        .nest_service("/mywishlist/gifts/{a}/edit", serve_dir.clone())
        .nest_service("/myfriends", serve_dir.clone())
        .nest_service("/friend/{a}", serve_dir.clone())
        .nest_service("/friend/{a}/add-gift", serve_dir.clone())
        .nest_service("/friend/{a}/gifts/{id}/edit", serve_dir.clone())
        .nest_service("/friend/{a}/gifts/{id}", serve_dir.clone())
